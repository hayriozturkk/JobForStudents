...
namespace JobForStudents
{
    ...
    { ResponseCodeEnum.GetSchoolByNameRequired, "Lütfen Okul İsmini Kontrol Ediniz" },
    ...
    { ResponseCodeEnum.GetJobAdvertisementBySalaryOperationFail, "Girilen Ücret Aralığında İş İlanı Bulunamdı" },
    { ResponseCodeEnum.GetJobAdvertisementByCategoryOperationFail, "Girilen Categoride İş İlanı Bulunamadı" },
    { ResponseCodeEnum.GetJobAdvertisementByTitleOperationFail, "Girilen Titleda İş İlanı Bulunamadı" },
    { ResponseCodeEnum.GetJobAdvertisementByCityOperationFail, "Girilen Şehirde İş İlanı Bulunamadı" },
    { ResponseCodeEnum.GetJobAdvertisementByDistrictOperationFail, "Girilen İlçede İş İlanı Bulunamadı" },
    { ResponseCodeEnum.GetJobAdvertisementByNameOperationFail, "Girilen İsimde İş İlanı Bulunamadı" },
    { ResponseCodeEnum.GetJobAdvertisementByWorkingTimeOperationFail, "Girilen Çalışma Zamanında İş İlanı Bulunamadı" },
    ...
    { ResponseCodeEnum.GetEmployersByBirthDateRequired, "Doğum Tarihleri Alanından en az biri dolu olmalıdır,Lütfen Tarihleri Kontrol Ediniz" },
    { ResponseCodeEnum.GetEmployersByBirthDateOperationFail, "Girilen Doğum Tarihleri Arasında Kayıtlı İşveren bulunamadı" },
    { ResponseCodeEnum.GetEmployerByNameRequired, "Lütfen İsim Alanını Kontrol Ediniz" },
    ...
    { ResponseCodeEnum.GetCompanyByCategoryOperationFail, "Girilen Kategoriye Göre Şirket Bulunamadı" },
    ...
    { ResponseCodeEnum.GetCompanyByCityOperationFail, "Girilen Şehire Göre Şirket Bulunamadı" },
    { ResponseCodeEnum.GetCompanyByDistrictOperationFail, "Girilen İlçeye Göre Şirket Bulunamadı" },
